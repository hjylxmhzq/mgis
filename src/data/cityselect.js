...
export default function CascaderCity(props={}) {
    return <Cascader style={props.style} options={addr} placeholder={props.defaultCity ? props.defaultCity:'请选择'} onChange={props.onChange}></Cascader>
}
